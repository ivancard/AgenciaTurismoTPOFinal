<%-- 
    ...
    Created on : 20/12/2021, 15:44:37
    Author     : ivanc
--%>
...
<html>
    ...
    <body>
        <% //Validacion de usario 
                ...
                <div class="caja-pp">
                    <div class="login-box" style="width: 70%; height: 70%;">
                        ...
                        <div class="contenedor-tabla">
                            ...
                            <%
                                List<Cliente> listaClientesa = control.obtenerClientes();
                                
                                for (Cliente cliente : listaClientesa) {
                            ...
                            %>
                                <tr>
                                    ...
                                    <td><%=email%></td>
                                    <td>
                                        <form class="formEditar" action="SvEditarCliente" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idAEdtarCliente" value="<%=id%>">
                                    ...
                                    <td>
                                        <form action="SvEliminarCliente" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idABorrar" value="<%=id%>">

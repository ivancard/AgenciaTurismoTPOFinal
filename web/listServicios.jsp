<%-- 
    ...
    Created on : 20/12/2021, 17:54:52
    Author     : ivanc
--%>
...
<html>
    ...
    <body>
        <% //Validacion de usario 
                ...
                <div class="caja-pp">
                    <div class="login-box" style="width: 65%; height: 70%;">
                        ...
                        <div class="contenedor-tabla">
                            ...
                            <%
                                List<Servicio> listaservicios= control.obtenerServicios();
                                
                                for (Servicio servicio : listaservicios) {
                                        
                                   
                                        String id = servicio.getId()+"";
                                        String nombre = servicio.getNombreServ();
                                        String descripcion = servicio.getDescripcion();
                                        String costo = servicio.getCosto() + "";
                                        String destino = servicio.getDestino();
                                        
                                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd"); 
                                        String fechaComoCadena = sdf.format(servicio.getFecha());
                            ...
                            %>
                                <tr>
                                    ...
                                    <td>
                                        <form class="formEditar" action="SvEditarServicio" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idAEditarServicio" value="<%=id%>">
                                    ...
                                    <td>
                                        <form action="SvEliminarServicio" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idABorrarServicio" value="<%=id%>">

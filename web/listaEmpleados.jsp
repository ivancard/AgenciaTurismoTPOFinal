<%-- 
    ...
    Created on : 20/12/2021, 17:33:25
    Author     : ivanc
--%>
                        ...
                        <div class="contenedor-tabla">
                            ...
                            <%
                                ...
                                for (Empleado empleado : listaEmpleados) {
                                        ...
                                        String usuario = empleado.getUser().getCuenta();
                            ...
                            %>
                                <tr>
                                    ...
                                    <td><%=usuario%></td>
                                    <td>
                                        <form class="formEditar" action="SvEditarEmpleado" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idAEditarEmple" value="<%=id%>">
                                    ...
                                    <td>
                                        <form action="SvEliminarEmpleado" method="post">
                                            <input type="text" style="visibility: hidden; display: none;" name="idABorrarEmple" value="<%=id%>">

<%-- Document : index Created on : 07/12/2021, 11:59:42 Author : ivanc --%>
        ...
        <div class="login-box">
            <svg class="logo-completo" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg"
                ...
                <defs>
                    ...
                    <linearGradient id="Degradado_sin_nombre_2" x1="206.68" y1="90.67" x2="169.71" y2="179.33"
                        gradientTransform="matrix(0, -1, -1, 0, 371.68, 371.68)" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="#24a6e0" />
                        <stop offset="1" stop-color="#2474e0" />
                    </linearGradient>
                    <linearGradient id="Degradado_sin_nombre_4" x1="235.45" y1="81.19" x2="237.25" y2="93.39"
                        xlink:href="#Degradado_sin_nombre_2" />
                    <linearGradient id="Degradado_sin_nombre_11" x1="174" y1="187.79" x2="207.89" y2="112.82"
                        gradientTransform="matrix(0, -1, -1, 0, 371.68, 371.68)" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="#24a6e0" />
                        <stop offset="1" stop-color="#24a6e0" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient id="Degradado_sin_nombre_8" x1="243.07" y1="102.42" x2="262.45" y2="95.23"
                        gradientTransform="matrix(0, -1, -1, 0, 371.68, 371.68)" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="#2474e0" />
                        <stop offset="1" stop-color="#24a6e0" />
                    </linearGradient>
                    <linearGradient id="Degradado_sin_nombre_6" x1="236.9" y1="114.61" x2="236.9" y2="100.89"
                        xlink:href="#Degradado_sin_nombre_2" />
                    <linearGradient id="Degradado_sin_nombre_12" x1="124.33" y1="178.74" x2="203.66" y2="106.6"
            ...
            <hr>
            <form class="form" action="SvLogin" method="post" autocomplete="off">
                <p>
                ...
                <input value="Acceder" type="submit" name="btnSubmit" id="btnSubmit">
            </form>
        </div>
    </div>
